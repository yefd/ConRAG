...
def get_qa_instruction(
    question: str, documents: List, retrieval_aware: bool, RETRIEVAL_TOKEN, use_cot):
    if not question:
...
def load_dureader_dataset(input_path, max_prompt_length, tokenizer, retrieval_aware=True, use_cot=False, RETRIEVAL_TOKEN='<R>', dataset_seed=42):
