...
class ReaderDataset(Dataset):
    ...
    def __init__(self, dataset, n_context=None, chain_key="chains", question_prefix='question:', title_prefix='title:', passage_prefix='context:', **kwargs):
...
class ReaderDatasetWithChains(ReaderDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.n_context is not None and self.n_context > 0:
            contexts = [{"title": ctx["title"], "sentences": ctx["sentences"]} for ctx in example["ctxs_kg"]]
            chains = []
