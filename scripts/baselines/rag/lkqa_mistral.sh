...
nohup python runner.py \
    ...
    --model_name models/polylm-chat-13b \
    ...
    >  logs/lkqa/output_rag_polylm.log 2>&1 &
...
nohup python runner.py \
    ...
    --instruction_type instruction \
    >  logs/lkqa/output_conrag_standard_polylm.log 2>&1 &
...
nohup python runner.py \
    ...
    >  logs/lkqa/output_rag_mistral.log 2>&1 ;
...
nohup python runner.py \
    ...
    >  logs/lkqa/output_rag_qwen.log 2>&1 ;
