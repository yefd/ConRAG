...
nohup python runner.py \
    ...
    --output_dir output/models/conrag_7b_1118_mistral \
    --use_training \
    --freeze_llm \
    --completion_only \
    --num_k 20 \
    ...
    >  logs/musique/output_conrag_standard_llama2.log 2>&1 &
...
nohup python runner.py \
    ...
    --per_device_train_batch_size 1 \
    --instruction_type chat \
    >  logs/musique/output_conrag_standard_llama2_e2.log 2>&1 &